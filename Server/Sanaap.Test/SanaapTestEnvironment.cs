...
namespace Sanaap.Test
{
    public class SanaapTestEnvironment : TestEnvironmentBase
    {
        ...
        protected override List<Func<TypeInfo, bool>> GetAutoProxyCreationIncludeRules()
        {
            ...
            baseList.Add(implementationType => implementationType.Assembly == Assembly.Load("Sanaap.Api"));
            baseList.Add(implementationType => implementationType.Assembly == Assembly.Load("Sanaap.Model"));
            baseList.Add(implementationType => implementationType.Assembly == Assembly.Load("Sanaap.Service"));
            baseList.Add(implementationType => implementationType.Assembly == Assembly.Load("Sanaap.Data"));
